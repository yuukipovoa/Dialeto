...
public class RegistroAlunoModel {
	...
	public String toString() {
		return "RegistroAlunoModel [nome=" + nome + ", sexo=" + Arrays.toString(sexo) + ", email=" + email + ", cpf="
				+ cpf + ", telefone=" + telefone + ", dataNascimento=" + dataNascimento + ", senha=" + senha
				+ ", senhaComfirm=" + senhaConfirm + "]";
	}
